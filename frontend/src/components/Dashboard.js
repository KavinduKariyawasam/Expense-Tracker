          ...
          <>
            <div className="stat-card primary">
              ...
              <div className="stat-info">
                ...
                <small>{stats.recent_income_transactions} transactions</small>
              </div>
            </div>
            ...
            <div className="stat-card secondary">
              ...
              <div className="stat-info">
                ...
                <small>{stats.recent_expense_transactions} transactions</small>
              </div>
            </div>
            ...
            <div className="stat-card quaternary">
              ...
              <div className="stat-info">
                ...
                <small>{stats.monthly_net >= 0 ? "Surplus" : "Deficit"}</small>
              </div>
            </div>
          </>
        ) : (
