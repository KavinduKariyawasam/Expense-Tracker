...
def ocr_space_file(filename, overlay=False, api_key=OCR_SPACE_API_KEY, language='eng', use_preprocessing=True):
...
if __name__ == "__main__":
    result = ocr_space_file('D:\\Projects\\expense\\data\\images\\13.jpg', 
